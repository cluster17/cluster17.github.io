...
<div id="navigation" class="sticky">
  <nav class="top-bar" role="navigation" data-topbar>
    <ul class="title-area">
      <li class="name">
      <h1 class="show-for-small-only"><a href="http://localhost:4000" class="icon-tree"> IEEE Cluster 2017</a></h1>
    </li>
    ...
    <section class="top-bar-section">
      ...
      <ul class="left">
              ...
              <li><a href="http://localhost:4000/committees">Committees</a></li>
              <li class="divider"></li>
...
<div id="masthead-no-image-header">
	<div class="row">
		<div class="small-12 columns">
			<a id="logo" href="http://localhost:4000" title="IEEE Cluster 2017 – International Conference on Cluster Computing">
				<img src="http://localhost:4000/assets/img/logo.png" alt="IEEE Cluster 2017 – International Conference on Cluster Computing">
			</a>
